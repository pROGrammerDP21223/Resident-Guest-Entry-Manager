                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input id="apartment" name="apartment" type="text" class="form-control" placeholder="Apartment No :" required>
                                                </div>
                                            </div>  
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label">Floor / Wing</label>
                                                    <input id="floor" name="floor"  type="text" class="form-control" placeholder="Floor/Wing :" required>
                                                </div>
                                            </div>  
                                            <div class="col-md-6">
                                                <div class="mb-3">
